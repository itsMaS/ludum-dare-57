    ...
    public partial class LegsAnimatorEditor
    {
        ...
        public void DisplaySetupPoseGUI()
        {
            ...
            if (Get.SetupPose.IsSet(Get))
            {
                ...
                if (GUILayout.Button(new GUIContent(FGUI_Resources.Tex_Remove, "Clear the stored reference pose if you don't want to use it."), FGUI_Resources.ButtonStyle)) { Get.SetupPose.Clear(); OnChange(); }
